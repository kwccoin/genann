...
int main(int argc, char *argv[])
{
    ...
    FILE *fp;
    fp=fopen("/Users/blue5/Movies/okoka2j.bin", "wb");
    ...
    fp4 = fopen("/Users/blue5/Movies/okoka2j.bin", "r");
    fscanf(fp4, "%s", buff4);
    printf("4a : %s\n", buff4 );
    ...
    fp2 = fopen("okokb2m.txt", "w+"); // Ok to read and write but it goes to DEBUG !!!!!
