...
void load_data() {
    ...
    FILE *in = fopen(iris_data,"r"); //example/iris.data", "r"); and change to the filename not replicate the case
    ...
    /* Loop through the data to get a count. */  // just count and loop through the whole files
    char line[1024];
    while (!feof(in) && fgets(line, 1024, in)) { // one line is like this : 5.1,3.5,1.4,0.2,Iris-setosa
        ++samples;
    }
    
    /*
     
     1180: 72 67 69 6E 69 63 61 0A     rginica.
     1188: 36 2E 32 2C 33 2E 34 2C     6.2,3.4,
     1190: 35 2E 34 2C 32 2E 33 2C     5.4,2.3,
     1198: 49 72 69 73 2D 76 69 72     Iris-vir
     11A0: 67 69 6E 69 63 61 0A 35     ginica.5
     11A8: 2E 39 2C 33 2E 30 2C 35     .9,3.0,5
     11B0: 2E 31 2C 31 2E 38 2C 49     .1,1.8,I
     11B8: 72 69 73 2D 76 69 72 67     ris-virg
     
     11C0: 69 6E 69 63 61 0A           inica.
    ...
    */
    ...
    input = malloc(sizeof(double) * samples * 4);  // all in memory
    class = malloc(sizeof(double) * samples * 3);  // all in memory
...
int example4dng() //int argc, char *argv[])
{
    printf("GENANN example 4.\n");
    printf("Train an ANN on the IRIS dataset using backpropagation; learning by dennis.\n");
